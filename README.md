...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly create remix-website-edd4
  fly create remix-website-edd4-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-website-edd4
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app remix-website-edd4-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'remix-website-edd4-staging' does not match app name in config file 'remix-website-edd4'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name remix-website-edd4-db
  fly postgres attach --postgres-app remix-website-edd4-db --app remix-website-edd4

  fly postgres create --name remix-website-edd4-staging-db
  fly postgres attach --postgres-app remix-website-edd4-staging-db --app remix-website-edd4-staging
  ```
